...
class IOElectron
 {
	...
	public:
		...
		Float_t Full5x5SigmaIEtaIEta() const;
		...
		void Full5x5SigmaIEtaIEta(Float_t _Full5x5SigmaIEtaIEta);
...
class Data_IOGenAK4Jet
 {
	...
	public:
		void Fill();
		Data_IOGenAK4Jet(UInt_t size, std::string prefix);
		~Data_IOGenAK4Jet();
		void SetUpWrite(TTree* tree);
		void SetUpRead(TTree* tree);
		void Load(TTree* tree, bool load);
...
class IOGenAK4Jet
 {
	...
	private:
		static BaseIO* baseio;
		UInt_t number_;
		Data_IOGenAK4Jet* data_;
	public:
		IOGenAK4Jet(Data_IOGenAK4Jet* data, UInt_t number);
		IOGenAK4Jet(const IOGenAK4Jet& _iogenak4jet);
		void Init();
		Float_t e() const;
		Float_t px() const;
		Float_t py() const;
		Float_t pz() const;
		Float_t einvisible() const;
		void e(Float_t _e);
		void px(Float_t _px);
		void py(Float_t _py);
		void pz(Float_t _pz);
		void einvisible(Float_t _einvisible);
 };
...
class BaseIO
{
	...
	friend class IOString;
	private:
		Data_IOGenAK4Jet IOGenAK4Jet_container_;
	...
	public:
		...
		UInt_t NumIOGenAK4Jets();
		IOGenAK4Jet GetIOGenAK4Jet(UInt_t n);
		void LoadIOGenAK4Jet(bool load);
		UInt_t NumGenInfos();
