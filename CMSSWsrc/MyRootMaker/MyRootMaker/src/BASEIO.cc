...
, GSFTrack_(new Data_IOTrack(size_, prefix_ + "_GSFTrack"))
{
	...
	Full5x5SigmaIEtaIEta_ = new Float_t[size_];
...
void Data_IOElectron::SetUpWrite(TTree* tree)
{
	...
	tree->Branch((prefix_ + "_Full5x5SigmaIEtaIEta").c_str(), Full5x5SigmaIEtaIEta_, (prefix_ + "_Full5x5SigmaIEtaIEta[" + prefix_ + "_count]/F").c_str());
...
void Data_IOElectron::SetUpRead(TTree* tree)
{
	...
	tree->SetBranchAddress((prefix_ + "_Full5x5SigmaIEtaIEta").c_str(), Full5x5SigmaIEtaIEta_);
...
void Data_IOElectron::Load(TTree* tree, bool load)
{
	...
	tree->SetBranchStatus((prefix_ + "_Full5x5SigmaIEtaIEta").c_str(), load);
...
Float_t IOElectron::Full5x5SigmaIEtaIEta() const
{
	return data_->Full5x5SigmaIEtaIEta_[number_];
}
...
void IOElectron::Full5x5SigmaIEtaIEta(Float_t _Full5x5SigmaIEtaIEta)
{
	if(number_ >= data_->size_)
	{
	...
	data_->Full5x5SigmaIEtaIEta_[number_] = _Full5x5SigmaIEtaIEta;
}
...
//Data_IOGenAK4Jet Data_IOGenAK4Jet Data_IOGenAK4Jet Data_IOGenAK4Jet Data_IOGenAK4Jet Data_IOGenAK4Jet Data_IOGenAK4Jet Data_IOGenAK4Jet Data_IOGenAK4Jet Data_IOGenAK4Jet 
BaseIO* Data_IOGenAK4Jet::baseio = 0;
Data_IOGenAK4Jet::Data_IOGenAK4Jet(UInt_t size, std::string prefix = "") : 
size_(size),
prefix_(prefix)
{
	e_ = new Float_t[size_];
	...
	py_ = new Float_t[size_];
	pz_ = new Float_t[size_];
	einvisible_ = new Float_t[size_];
}

Data_IOGenAK4Jet::~Data_IOGenAK4Jet()
{
	delete[] e_;
	delete[] px_;
	delete[] py_;
...
void Data_IOGenAK4Jet::Fill()
{
	count_ = 0;
}

void Data_IOGenAK4Jet::SetUpWrite(TTree* tree)
{
	tree->Branch((prefix_ + "_count").c_str(), &count_, (prefix_ + "_count/i").c_str());
	tree->Branch((prefix_ + "_e").c_str(), e_, (prefix_ + "_e[" + prefix_ + "_count]/F").c_str());
	tree->Branch((prefix_ + "_px").c_str(), px_, (prefix_ + "_px[" + prefix_ + "_count]/F").c_str());
	tree->Branch((prefix_ + "_py").c_str(), py_, (prefix_ + "_py[" + prefix_ + "_count]/F").c_str());
	tree->Branch((prefix_ + "_pz").c_str(), pz_, (prefix_ + "_pz[" + prefix_ + "_count]/F").c_str());
	tree->Branch((prefix_ + "_einvisible").c_str(), einvisible_, (prefix_ + "_einvisible[" + prefix_ + "_count]/F").c_str());
}

void Data_IOGenAK4Jet::SetUpRead(TTree* tree)
{
	tree->SetBranchAddress((prefix_ + "_count").c_str(), &count_);
	tree->SetBranchAddress((prefix_ + "_e").c_str(), e_);
	tree->SetBranchAddress((prefix_ + "_px").c_str(), px_);
	tree->SetBranchAddress((prefix_ + "_py").c_str(), py_);
	tree->SetBranchAddress((prefix_ + "_pz").c_str(), pz_);
	tree->SetBranchAddress((prefix_ + "_einvisible").c_str(), einvisible_);
}

void Data_IOGenAK4Jet::Load(TTree* tree, bool load)
{
	tree->SetBranchStatus((prefix_ + "_count").c_str(), load);
	tree->SetBranchStatus((prefix_ + "_e").c_str(), load);
	tree->SetBranchStatus((prefix_ + "_px").c_str(), load);
	tree->SetBranchStatus((prefix_ + "_py").c_str(), load);
	tree->SetBranchStatus((prefix_ + "_pz").c_str(), load);
	tree->SetBranchStatus((prefix_ + "_einvisible").c_str(), load);
}



//IOGenAK4Jet == IOGenAK4Jet == IOGenAK4Jet == IOGenAK4Jet == IOGenAK4Jet == IOGenAK4Jet == IOGenAK4Jet == IOGenAK4Jet == IOGenAK4Jet == IOGenAK4Jet == IOGenAK4Jet == IOGenAK4Jet == IOGenAK4Jet == IOGenAK4Jet == IOGenAK4Jet == 
BaseIO* IOGenAK4Jet::baseio = 0;
IOGenAK4Jet::IOGenAK4Jet(Data_IOGenAK4Jet* data, UInt_t number) : 
number_(number),
data_(data)
{
	Init();
...
IOGenAK4Jet::IOGenAK4Jet(const IOGenAK4Jet& _iogenak4jet) : 
number_( _iogenak4jet.number_),
data_( _iogenak4jet.data_)
{
}

void IOGenAK4Jet::Init()
{
	if(baseio->IsWritable())
	{
		data_->count_ = number_+1;
...
Float_t IOGenAK4Jet::e() const
{
	return data_->e_[number_];
}

Float_t IOGenAK4Jet::px() const
{
	return data_->px_[number_];
}

Float_t IOGenAK4Jet::py() const
{
	return data_->py_[number_];
}

Float_t IOGenAK4Jet::pz() const
{
	return data_->pz_[number_];
}

Float_t IOGenAK4Jet::einvisible() const
{
	return data_->einvisible_[number_];
}

void IOGenAK4Jet::e(Float_t _e)
{
	if(number_ >= data_->size_)
	{
...
void IOGenAK4Jet::px(Float_t _px)
{
	if(number_ >= data_->size_)
	{
...
void IOGenAK4Jet::py(Float_t _py)
{
	if(number_ >= data_->size_)
	{
...
void IOGenAK4Jet::pz(Float_t _pz)
{
	if(number_ >= data_->size_)
	{
...
void IOGenAK4Jet::einvisible(Float_t _einvisible)
{
	if(number_ >= data_->size_)
	{
	...
	data_->einvisible_[number_] = _einvisible;
}
...
void Data_PFIsolation::SetUpWrite(TTree* tree)
{
	...
	tree->Branch((prefix_ + "_ChargedPU").c_str(), ChargedPU_, (prefix_ + "_ChargedPU[" + prefix_ + "_count]/F").c_str());
}
...
void Data_PFIsolation::SetUpRead(TTree* tree)
{
	...
	tree->SetBranchAddress((prefix_ + "_ChargedPU").c_str(), ChargedPU_);
}
...
void Data_PFIsolation::Load(TTree* tree, bool load)
{
	...
	tree->SetBranchStatus((prefix_ + "_ChargedPU").c_str(), load);
}
...
Float_t PFIsolation::ChargedPU() const
{
	return data_->ChargedPU_[number_];
}
...
void PFIsolation::ChargedPU(Float_t _ChargedPU)
{
	if(number_ >= data_->size_)
	{
	...
	data_->ChargedPU_[number_] = _ChargedPU;
}
...
IOGenAK4Jet_container_(200, "IOGenAK4Jet"),
...
treename_(treename)
{
	...
	IOGenAK4Jet::baseio = this;
	Data_IOGenAK4Jet::baseio = this;
...
void BaseIO::SetFile(TFile* file)
{
	if(writable_)
	{
		...
		IOGenAK4Jet_container_.SetUpWrite(tree_);
	...
	else
	{
		...
		IOGenAK4Jet_container_.SetUpRead(tree_);
...
UInt_t BaseIO::NumIOGenAK4Jets()
{
	return IOGenAK4Jet_container_.count_;
}
IOGenAK4Jet BaseIO::GetIOGenAK4Jet(UInt_t n)
{
	return IOGenAK4Jet(&IOGenAK4Jet_container_, n);
}
void BaseIO::LoadIOGenAK4Jet(bool load)
{
	IOGenAK4Jet_container_.Load(tree_, load);
}
